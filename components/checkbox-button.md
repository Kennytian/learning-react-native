  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <CheckBoxButton titleLines={1} title={'销售代表'} value={'xsdb'} titleNormalStyle={{fontSize: 20, color: 'gray'}}
                        titleCheckStyle={{fontSize: 20, color: 'blue'}} bgNormalStyle={{
          width: 143,
          height: 53,
          borderRadius: 1.5,
          alignItems: 'center',
        ...
        }} checked={this.state.checkBoxButton1} onPress={this.checkBoxButton1Handler}/>
        <Text>1</Text>
        <CheckBoxButton ref="a2" title={'销售经理主管与总监'} value={'xsjlzgyzj'} checked={this.state.checkBoxButton2}
